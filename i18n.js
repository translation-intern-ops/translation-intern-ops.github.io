...
const messages = {
  zh: {
    ...
    "reports.knowledgeByCategory": "知识库（按分类）",
    "reports.knowledgeByLanguage": "知识库（按语言）",
    "reports.knowledgeTotal": "知识库总量",
    "reports.status.todo": "未完成",
    "reports.status.doing": "进行中",
    "reports.status.review": "复核中",
    ...
    "reports.noKnowledgeData": "暂无知识库数据。",
    ...
    "guides.pin": "置顶",
    "guides.unpin": "取消置顶",
    "guides.viewFull": "查看完整内容",
    "guides.expand": "展开全文",
    "guides.collapse": "收起全文",
    "guides.foldCard": "收起",
    "guides.unfoldCard": "展开",
    "lang.en": "英语",
    "lang.ja": "日语",
    "lang.ko": "韩语",
    "lang.fr": "法语",
    ...
    "toast.productSelectRequired": "请从列表中选择有效的产品中心。",
    ...
    "toast.syncConflictReloaded": "检测到同事已更新，已自动刷新到最新版本。",
    "toast.backupExported": "备份已导出到本地文件。",
    "sync.export": "导出备份",
    "month.jan": "01月",
    "month.feb": "02月",
    "month.mar": "03月",
  ...
  en: {
    ...
    "taskForm.productPh": "Search or select product",
    ...
    "reports.knowledgeByCategory": "Knowledge (by category)",
    "reports.knowledgeByLanguage": "Knowledge (by language)",
    "reports.knowledgeTotal": "Total entries",
    "reports.status.todo": "Incomplete",
    "reports.status.doing": "In progress",
    "reports.status.review": "In review",
    "reports.status.done": "Completed",
    ...
    "reports.noKnowledgeData": "No knowledge entries yet.",
    ...
    "guides.pin": "Pin",
    "guides.unpin": "Unpin",
    "guides.viewFull": "View full content",
    "guides.expand": "Show more",
    "guides.collapse": "Show less",
    "guides.foldCard": "Collapse",
    "guides.unfoldCard": "Expand",
    "lang.en": "English",
    "lang.ja": "Japanese",
    "lang.ko": "Korean",
    "lang.fr": "French",
    ...
    "toast.productSelectRequired": "Please select a valid product center from the list.",
    ...
    "toast.legacyVaultLogin": "Encrypted backup found. Sign in with the team password to restore data.",
    "auth.decryptFailed": "Could not decrypt the backup. Check the team password.",
    ...
    "sync.status.pg": "Connected to Matrix PostgreSQL. Changes sync for the team.",
    ...
    "toast.syncConflictReloaded": "A teammate update was detected. Latest data has been reloaded.",
    "toast.backupExported": "Backup exported to local file.",
    "sync.export": "Export backup",
    "month.jan": "Jan",
    "month.feb": "Feb",
    "month.mar": "Mar",
    "month.apr": "Apr",
